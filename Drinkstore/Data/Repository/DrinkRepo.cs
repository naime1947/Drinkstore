...
namespace Drinkstore.Data.Repository
{
    ...
    {
        private readonly ICategoryRepository _categoryRepository = new CategoryRepo();
        ...
        public IEnumerable<Drink> PreferedDrinks { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
